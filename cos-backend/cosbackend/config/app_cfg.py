# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in cos-backend.
...
import cosbackend
from cosbackend import model, lib
...
base_config.package = cosbackend
...
base_config.model = cosbackend.model
base_config.DBSession = cosbackend.model.DBSession
# Configure the authentication backend
base_config.auth_backend = 'sqlalchemy'
# YOU MUST CHANGE THIS VALUE IN PRODUCTION TO SECURE YOUR APP
base_config.sa_auth.cookie_secret = "d1fe542d-5ad3-4ad6-87c0-29d67dd877aa"
